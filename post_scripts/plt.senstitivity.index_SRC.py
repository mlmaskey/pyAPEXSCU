...
# sobol
df_f1_first_ng = gather_data_index(file_sensitivity_first[0], method='SRC')
df_f1_total_ng = gather_data_index(file_sensitivity_Total[0], method='SRC')

df_f1_first_g = gather_data_index(file_sensitivity_first[1], method='SRC')
df_f1_total_g = gather_data_index(file_sensitivity_Total[1], method='SRC')

df_f8_first_ng = gather_data_index(file_sensitivity_first[2], method='SRC')
df_f8_total_ng = gather_data_index(file_sensitivity_Total[2], method='SRC')

df_f8_first_g = gather_data_index(file_sensitivity_first[3], method='SRC')
df_f8_total_g = gather_data_index(file_sensitivity_Total[3], method='SRC')
...
axes[0, 0].set_xlabel('SRC (First)', fontsize=14)
...
axes[1, 0] = sns.barplot(data=df_f1_total, x='Sensitivity Index', y='Parameters', hue='Operation', ax=axes[1, 0],
                         palette=['red', 'blue'])
axes[1, 0].set_xlabel('SRC (Total)', fontsize=14)
...
axes[0, 1] = sns.barplot(data=df_f8_first, x='Sensitivity Index', y='Parameters', hue='Operation', ax=axes[0, 1],
                         palette=['red', 'blue'])
axes[0, 1].set_xlabel('SRC (First)', fontsize=14)
...
axes[1, 1] = sns.barplot(data=df_f8_total, x='Sensitivity Index', y='Parameters', hue='Operation', ax=axes[1, 1],
                         palette=['red', 'blue'])
axes[1, 1].set_xlabel('SRC (Total)', fontsize=14)
