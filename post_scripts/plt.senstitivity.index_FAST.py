...
# sobol
df_f1_first_ng = gather_data_index(file_sensitivity_first[0], method='FAST')
df_f1_total_ng = gather_data_index(file_sensitivity_Total[0], method='FAST')

df_f1_first_g = gather_data_index(file_sensitivity_first[1], method='FAST')
df_f1_total_g = gather_data_index(file_sensitivity_Total[1], method='FAST')

df_f8_first_ng = gather_data_index(file_sensitivity_first[2], method='FAST')
df_f8_total_ng = gather_data_index(file_sensitivity_Total[2], method='FAST')

df_f8_first_g = gather_data_index(file_sensitivity_first[3], method='FAST')
df_f8_total_g = gather_data_index(file_sensitivity_Total[3], method='FAST')
...
fig, axes = plt.subplots(2, 2, figsize=(10, 10), tight_layout=True, sharex=False, sharey=True)
...
axes[0, 1].set_xlabel('FAST (First)', fontsize=14)
axes[0, 1].set_ylabel('', fontsize=14)
axes[0, 1].set_xscale('log')
axes[0, 1].set_xlim(1E-6, 1)
axes[0, 1].grid(True)
