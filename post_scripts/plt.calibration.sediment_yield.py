...
file_lists4farm1 = ['../post_analysis/Calibration/Farm_1/non_grazing/sediment/daily_outlet_daily_PBIAS_daily.csv',
                    '../post_analysis/Calibration/Farm_1/non_grazing/sediment/daily_outlet_daily_PBIAS_monthly.csv',
                    '../post_analysis/Calibration/Farm_1/non_grazing/sediment/daily_outlet_daily_PBIAS_yearly.csv',
                    '../post_analysis/Calibration/Farm_1/grazing/sediment/daily_outlet_daily_PBIAS_daily.csv',
                    '../post_analysis/Calibration/Farm_1/grazing/sediment/daily_outlet_daily_PBIAS_monthly.csv',
                    '../post_analysis/Calibration/Farm_1/grazing/sediment/daily_outlet_daily_PBIAS_yearly.csv']
...
plt.tight_layout()
plt.savefig(os.path.join(graph_dir, 'Calibration_sediment_Farm_1_non_grazing_correlation.png'),
...
axes[2, 2].legend(loc='upper center', bbox_to_anchor=(0.5, -0.20), ncol=2)
plt.tight_layout()
plt.savefig(os.path.join(graph_dir, 'Calibration_sediment_Farm_1_grazing_correlation.png'),
            dpi=600, bbox_inches="tight")
plt.show()

# Farm 8  based on temporal optimization at different metrices
file_lists4farm8 = ['../post_analysis/Calibration/Farm_8/non_grazing/sediment/daily_outlet_daily_COD_daily.csv',
                    '../post_analysis/Calibration/Farm_8/non_grazing/sediment/daily_outlet_daily_COD_monthly.csv',
                    '../post_analysis/Calibration/Farm_8/non_grazing/sediment/daily_outlet_daily_COD_yearly.csv',
                    '../post_analysis/Calibration/Farm_8/grazing/sediment/daily_outlet_daily_COD_daily.csv',
                    '../post_analysis/Calibration/Farm_8/grazing/sediment/daily_outlet_daily_COD_monthly.csv',
                    '../post_analysis/Calibration/Farm_8/grazing/sediment/daily_outlet_daily_COD_yearly.csv']
...
axes[2, 2].legend(loc='upper center', bbox_to_anchor=(0.5, -0.20), ncol=2)
plt.tight_layout()
plt.savefig(os.path.join(graph_dir, 'Calibration_sediment_Farm_8_non_grazing_correlation.png'),
            dpi=600, bbox_inches="tight")
plt.show()
plt.close('all')
...
axes[2, 2].legend(loc='upper center', bbox_to_anchor=(0.5, -0.20), ncol=2)
plt.tight_layout()
plt.savefig(os.path.join(graph_dir, 'Calibration_sediment_Farm_8_grazing_correlation.png'),
            dpi=600, bbox_inches="tight")
plt.show()
